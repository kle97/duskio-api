...
@RequestMapping(API_PATH +"categories")
...
public class CategoryController {
    ...
    @GetMapping("/{id}/posts")
    @Operation(summary = "Find category by id with posts")
    public ResponseEntity<CategoryResponse> findByIdWithPosts(@PathVariable int id) {
        return ResponseEntity.ok().body(categoryDao.findByIdWithPosts(id).orElseThrow(ResourceNotFoundException::new));
    }
